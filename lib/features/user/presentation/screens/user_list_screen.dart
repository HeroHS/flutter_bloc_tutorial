...
/// - Uses domain entities instead of models
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Demonstrates BLoC pattern with Use Cases and Repository pattern.',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'This app demonstrates Clean Architecture with BLoC pattern.\n'
              'BLoC → Use Case → Repository → Data Source',
